...
def test_oracle_to_mysql(oracle_with_table, create_dolt_test_data_commits):
    ...
    dolt_repo, dolt_table = create_dolt_test_data_commits
    validate_dolt_as_source(oracle_conn, oracle_table, get_oracle_target_writer, dolt_repo, dolt_table)


@pytest.mark.sql_sync
def test_oracle_to_dolt(oracle_with_table, repo_with_table):
    """
